...
- Topic for this invocation: **golden-globes-best-motion-picture-animated-winner**
- Search queries to start from: **["golden-globes-best-motion-picture-animated-winner predictions analysis", "golden-globes-best-motion-picture-animated-winner oddsmaker pick analysis", "golden-globes-best-motion-picture-animated-winner critic commentary preview", "golden-globes-best-motion-picture-animated-winner expert forecast roundup", "golden-globes-best-motion-picture-animated-winner variety deadline hollywood reporter", "golden-globes-best-motion-picture-animated-winner indiewire commentary", "golden-globes-best-motion-picture-animated-winner rotten tomatoes letterboxd"]**
- Target article count: **25** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/golden-globes-best-motion-picture-animated-winner**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/golden-globes-best-motion-picture-animated-winner/` named `article_<NNNN>.json`.
4. Aim for **25** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/golden-globes-best-motion-picture-animated-winner/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
```json
{
  ...
  "topic": "golden-globes-best-motion-picture-animated-winner",
  "source_type": "news_scraper.golden-globes-best-motion-picture-animated-winner"
}
```
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/golden-globes-best-motion-picture-animated-winner` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/golden-globes-best-motion-picture-animated-winner`.
