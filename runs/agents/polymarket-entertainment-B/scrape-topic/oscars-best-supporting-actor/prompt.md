...
- Topic for this invocation: **oscars-best-supporting-actor**
- Search queries to start from: **["oscars-best-supporting-actor predictions analysis", "oscars-best-supporting-actor oddsmaker pick analysis", "oscars-best-supporting-actor critic commentary preview", "oscars-best-supporting-actor expert forecast roundup", "oscars-best-supporting-actor variety deadline hollywood reporter", "oscars-best-supporting-actor indiewire commentary", "oscars-best-supporting-actor rotten tomatoes letterboxd"]**
- Target article count: **25** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-supporting-actor**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-supporting-actor/` named `article_<NNNN>.json`.
4. Aim for **25** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-supporting-actor/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
```json
{
  ...
  "topic": "oscars-best-supporting-actor",
  "source_type": "news_scraper.oscars-best-supporting-actor"
}
```
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-supporting-actor` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-supporting-actor`.
