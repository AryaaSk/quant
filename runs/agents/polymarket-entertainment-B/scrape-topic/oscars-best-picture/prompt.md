...
- Topic for this invocation: **oscars-best-picture**
- Search queries to start from: **["oscars-best-picture predictions analysis", "oscars-best-picture oddsmaker pick analysis", "oscars-best-picture critic commentary preview", "oscars-best-picture expert forecast roundup", "oscars-best-picture variety deadline hollywood reporter", "oscars-best-picture indiewire commentary", "oscars-best-picture rotten tomatoes letterboxd"]**
- Target article count: **25** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-picture**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-picture/` named `article_<NNNN>.json`.
4. Aim for **25** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-picture/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
```json
{
  ...
  "source_type": "news_scraper.oscars-best-picture"
}
```
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-picture` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/polymarket-entertainment-B/_news/oscars-best-picture`.
