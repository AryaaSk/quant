...
- Topic for this invocation: **INOD**
- Search queries to start from: **["INOD earnings preview 2024 Qq", "INOD stock news preview", "INOD guidance outlook quarterly results", "INOD analyst expectations", "INOD retail investor sentiment"]**
- Target article count: **80** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/INOD**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/INOD/` named `article_<NNNN>.json`.
4. Aim for **80** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/INOD/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/INOD` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/INOD`.
