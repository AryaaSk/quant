...
- Search queries to start from: **["AMC earnings preview 2022 Qq", "AMC earnings preview 2022 Qq", "AMC earnings preview 2022 Qq", "AMC earnings preview 2022 Qq", "AMC earnings preview 2023 Qq", "AMC earnings preview 2023 Qq", "AMC earnings preview 2023 Qq", "AMC earnings preview 2023 Qq", "AMC earnings preview 2024 Qq", "AMC earnings preview 2024 Qq", "AMC earnings preview 2024 Qq", "AMC earnings preview 2024 Qq", "AMC stock news preview", "AMC guidance outlook quarterly results", "AMC analyst expectations", "AMC retail investor sentiment"]**
- Target article count: **80** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/AMC**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/AMC/` named `article_<NNNN>.json`.
4. Aim for **80** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/AMC/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/AMC` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-beatmiss-B/_news/AMC`.
