...
- Market being researched: **betfair-eng-l1l2**
- Topic for this invocation: **manager**
- Search queries to start from: **["English League One manager press conference", "EFL manager interview tactics formation", "English Football League sacking appointment"]**
- Target article count: **80** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/betfair-eng-l1l2/_news/manager**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/betfair-eng-l1l2/_news/manager/` named `article_<NNNN>.json`.
4. Aim for **80** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/betfair-eng-l1l2/_news/manager/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
```json
{
  ...
  "topic": "manager",
  "source_type": "news_scraper.manager"
}
```
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/betfair-eng-l1l2/_news/manager` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/betfair-eng-l1l2/_news/manager`.
