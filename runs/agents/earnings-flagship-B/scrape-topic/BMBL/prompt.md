...
- Topic for this invocation: **BMBL**
- Search queries to start from: **["BMBL earnings preview 2021 Qq", "BMBL earnings preview 2021 Qq", "BMBL earnings preview 2021 Qq", "BMBL earnings preview 2022 Qq", "BMBL earnings preview 2022 Qq", "BMBL earnings preview 2022 Qq", "BMBL earnings preview 2022 Qq", "BMBL earnings preview 2023 Qq", "BMBL earnings preview 2023 Qq", "BMBL earnings preview 2023 Qq", "BMBL earnings preview 2023 Qq", "BMBL earnings preview 2024 Qq", "BMBL earnings preview 2024 Qq", "BMBL earnings preview 2024 Qq", "BMBL stock news preview", "BMBL guidance outlook quarterly results", "BMBL analyst expectations", "BMBL retail investor sentiment"]**
- Target article count: **30** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/BMBL**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/BMBL/` named `article_<NNNN>.json`.
4. Aim for **30** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/BMBL/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/BMBL` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/BMBL`.
