...
- Topic for this invocation: **ENVX**
- Search queries to start from: **["ENVX earnings preview 2021 Q4", "ENVX earnings preview 2022 Q1", "ENVX earnings preview 2022 Q2", "ENVX earnings preview 2022 Q3", "ENVX earnings preview 2022 Q4", "ENVX earnings preview 2023 Q1", "ENVX earnings preview 2023 Q2", "ENVX earnings preview 2023 Q3", "ENVX earnings preview 2023 Q4", "ENVX earnings preview 2024 Q1", "ENVX earnings preview 2024 Q2", "ENVX earnings preview 2024 Q3", "ENVX stock news preview", "ENVX guidance outlook quarterly results", "ENVX analyst expectations", "ENVX retail investor sentiment"]**
- Target article count: **30** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ENVX**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ENVX/` named `article_<NNNN>.json`.
4. Aim for **30** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ENVX/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ENVX` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ENVX`.
