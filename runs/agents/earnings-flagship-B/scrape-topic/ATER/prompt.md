...
- Topic for this invocation: **ATER**
- Search queries to start from: **["ATER earnings preview 2019 Qq", "ATER earnings preview 2020 Qq", "ATER earnings preview 2020 Qq", "ATER earnings preview 2020 Qq", "ATER earnings preview 2020 Qq", "ATER earnings preview 2021 Qq", "ATER earnings preview 2021 Qq", "ATER earnings preview 2021 Qq", "ATER earnings preview 2021 Qq", "ATER earnings preview 2022 Qq", "ATER earnings preview 2022 Qq", "ATER earnings preview 2022 Qq", "ATER earnings preview 2022 Qq", "ATER earnings preview 2023 Qq", "ATER earnings preview 2023 Qq", "ATER earnings preview 2023 Qq", "ATER earnings preview 2023 Qq", "ATER earnings preview 2024 Qq", "ATER earnings preview 2024 Qq", "ATER earnings preview 2024 Qq", "ATER stock news preview", "ATER guidance outlook quarterly results", "ATER analyst expectations", "ATER retail investor sentiment"]**
- Target article count: **30** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ATER**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ATER/` named `article_<NNNN>.json`.
4. Aim for **30** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ATER/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ATER` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/ATER`.
