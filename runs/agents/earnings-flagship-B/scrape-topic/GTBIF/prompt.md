...
- Topic for this invocation: **GTBIF**
- Search queries to start from: **["GTBIF earnings preview 2020 Q3", "GTBIF earnings preview 2021 Q1", "GTBIF earnings preview 2021 Q2", "GTBIF earnings preview 2021 Q3", "GTBIF earnings preview 2021 Q4", "GTBIF earnings preview 2022 Q1", "GTBIF earnings preview 2022 Q2", "GTBIF earnings preview 2022 Q3", "GTBIF earnings preview 2022 Q4", "GTBIF earnings preview 2023 Q1", "GTBIF earnings preview 2023 Q2", "GTBIF earnings preview 2023 Q3", "GTBIF earnings preview 2023 Q4", "GTBIF earnings preview 2024 Q1", "GTBIF earnings preview 2024 Q2", "GTBIF earnings preview 2024 Q3", "GTBIF stock news preview", "GTBIF guidance outlook quarterly results", "GTBIF analyst expectations", "GTBIF retail investor sentiment"]**
- Target article count: **30** (quality over quantity)
- Output directory (absolute): **/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/GTBIF**
...
3. Save each article as a separate JSON file in `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/GTBIF/` named `article_<NNNN>.json`.
4. Aim for **30** quality articles total across all queries. Stop early if budget runs low.
5. After saving, write a manifest file `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/GTBIF/_done` containing a single line: `count=<N> at=<ISO8601_now>`.
...
```json
{
  ...
  "topic": "GTBIF",
  "source_type": "news_scraper.GTBIF"
}
```
...
- Do not write code execution / Bash beyond `mkdir -p /Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/GTBIF` and simple file ops.
- Do not invent timestamps. Use `null` for `published_at` when unknown.
- Do not save articles with empty or junk `text`.
- Do not write any file outside `/Users/aryaask/Desktop/quant/data/raw/earnings-flagship-B/_news/GTBIF`.
